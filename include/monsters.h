 ...
 */
    ...
    MON("tengu", S_IMP, LVL(6, 13, 5, 30, 7), (G_GENO | 3),
        ...
        7, CLR_CYAN, TENGU),
    MON("Laplace's demon", S_IMP, LVL(8, 18, 0, 20, 0), (G_GENO | 0),
       A(ATTK(AT_CLAW, AD_PHYS, 2, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
         NO_ATTK),
       SIZ(20, 10, MS_TIP, MZ_TINY), 0, 0, M1_REGEN, M2_WANDER | M2_PEACEFUL,
        M2_DOMESTIC, M3_INFRAVISIBLE | M3_INFRAVISION, 4, CLR_WHITE),
    /*
     * jellies
     */
